...
public class AppRater {
    ...
    private final static String APP_TITLE = "English Grammar Master";// App Name
    private final static String APP_PNAME = "app.english.grammar.craftystudio.englishgrammar";// Package Name
